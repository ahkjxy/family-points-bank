...
const envAuthRedirect = (typeof process !== 'undefined' && process.env?.VITE_AUTH_REDIRECT) || (typeof import.meta !== 'undefined' && (import.meta as any)?.env?.VITE_AUTH_REDIRECT);
export const AUTH_REDIRECT = envAuthRedirect || (typeof window !== 'undefined' ? window.location.origin : 'http://localhost:5173');
