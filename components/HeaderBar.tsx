    ...
    <header className="flex justify-between items-center mb-10">
      ...
      <div className="flex gap-4 items-center">
        {isAdmin && (
          <button 
            onClick={onPrint} 
            className="px-4 py-2 rounded-full text-xs font-bold flex items-center gap-2 bg-white border border-gray-100 shadow-[0_10px_30px_-20px_rgba(0,0,0,0.4)] hover:-translate-y-[1px] transition-all"
          >
            <span className="w-8 h-8 rounded-full bg-gradient-to-br from-[#FF4D94]/15 to-[#7C4DFF]/15 flex items-center justify-center text-[#7C4DFF]">
              <Icon name="print" size={14} />
            </span>
            <span className="text-gray-700">打印手册</span>
          </button>
        )}
        <div className="px-5 py-3 bg-white rounded-2xl border border-gray-100 shadow-[0_18px_50px_-28px_rgba(0,0,0,0.45)] flex items-center gap-3 min-w-[160px]">
